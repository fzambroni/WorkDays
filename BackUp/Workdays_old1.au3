...
#AutoIt3Wrapper_Res_CompanyName=Dassault Systemes
...
Global $DBpMenu_db = GUICtrlCreateMenu("Database")
Global $DBpMenu_backup = GUICtrlCreateMenuItem("Create DB Backup", $DBpMenu_db)
...
;~ 	ConsoleWrite($Ratio_Q1 & " - " & Round(($Counta_R_Onsite_q1 / ($Counta_WD_q1 / 5)), 2) & @CRLF)
;~ 	ConsoleWrite($Ratio_Q2 & " - " & Round(($Counta_R_Onsite_q2 / ($Counta_WD_q2 / 5)), 2) & @CRLF)
;~ 	ConsoleWrite($Ratio_Q3 & " - " & Round(($Counta_R_Onsite_q3 / ($Counta_WD_q3 / 5)), 2) & @CRLF)
;~ 	ConsoleWrite($Ratio_Q4 & " - " & Round(($Counta_R_Onsite_q4 / ($Counta_WD_q4 / 5)), 2) & @CRLF)
...
Func _RestoreINIToRegistry()

EndFunc   ;==>_RestoreINIToRegistry

...
Global $BkpMenu_settings_colors = GUICtrlCreateMenuItem("Colors", $DBpMenu_settings)
...
While 1
	...
	Switch $nMsg
		...
		Case $BkpMenu_settings_colors
			$Return_Color = _ColorPallet()
...
$Form_Colors = GUICreate('Colors', 130, 280)
...
$Color_bk_Weekend = RegRead($DB, "Color_Weekend")
			...
			$Original_Color_2 = $Picker_Color_OnSite & $Picker_Color_Remote & $Picker_Color_Holiday & $Picker_Color_PTO & $Picker_Color_Travel & $Picker_Color_Sick & $Picker_Color_Blank & $Picker_Color_Weekend

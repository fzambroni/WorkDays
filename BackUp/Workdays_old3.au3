...
If $Data_Register = "T" Then GUICtrlSetBkColor($Inputs[$i][$J], 0xFF8000) ; Travel
...
If $Data_Register = "O" Then GUICtrlSetBkColor($Inputs[$i][$J], 0x00CC66) ; On-site


	If $Data_Register = "R" Then GUICtrlSetBkColor($Inputs[$i][$J], 0x0080FF) ; Remote

If $Data_Register = "P" Then GUICtrlSetBkColor($Inputs[$i][$J], 0x66FFFF) ; PTO

If $Status = "H" Then GUICtrlSetBkColor($Inputs[$i][$J], 0xFFFFCC) ; holiday

If $Status = "S" Then GUICtrlSetBkColor($Inputs[$i][$J], 0xFF6666) ; Sick

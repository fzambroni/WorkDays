...
Global $About = "1.0.1.3 - Custom colors and bug fixes" & @CRLF & "1.0.1.4 - Code polishing and new custom color palette" & @CRLF & "1.0.1.5 - Bug Fixes and improvements"
...
Func _GetColorGradient($value)
	ConsoleWrite("Passei aqui: " & $value & @CRLF)
	; Garante que o valor esteja entre 0.1 e 3.0
	If $value < 0.1 Then
		If $value = 0 Then
			$value = 0
		Else
...
EndIf
	...
	If $value <= 2.10 Then
		; Interpola��o de vermelho (255,0,0) at� amarelo (255,255,0)
		Local $ratio = ($value - 0.1) / (1.55 - 0.1)
		$r = 255
		$g = Round(255 * $ratio)
		$b = 0
	Else
...
;~ 			ConsoleWrite("Passei aqui: " & $value & @CRLF)
		Else
			Local $ratio = ($value - 1.55) / (3.0 - 1.55)
	...
	; Retorna em formato hexadecimal (ex: "0xFF8000")

...
$Picker_Font_Blank_Read = RegRead($DB, "Font_Blank")
$Font_Blank = $Black
...
Global $DBpMenu_backup = GUICtrlCreateMenuItem("Database Backup", $DBpMenu_backup_Data)
Global $BkpMenu_Batch = GUICtrlCreateMenuItem("Backup restore", $DBpMenu_backup_Data)

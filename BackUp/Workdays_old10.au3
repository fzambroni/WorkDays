...
$Picker_Font_OnSite_Read = RegRead($DB, "Font_OnSite")
$Font_OnSite = $Black
If $Picker_Font_OnSite_Read = 1 Then
	$Font_OnSite = $White
EndIf

$Picker_Font_Remote_Read = RegRead($DB, "Font_Remote")
$Font_Remote = $Black
If $Picker_Font_Remote_Read = 1 Then
	$Font_Remote = $White
EndIf

$Picker_Font_Holiday_Read = RegRead($DB, "Font_holiday")
$Font_Holiday = $Black
If $Picker_Font_Holiday_Read = 1 Then
	$Font_Holiday = $White
EndIf

$Picker_Font_PTO_Read = RegRead($DB, "Font_PTO")
$Font_PTO = $Black
If $Picker_Font_PTO_Read = 1 Then
	$Font_PTO = $White
EndIf

$Picker_Font_Travel_Read = RegRead($DB, "Font_Travel")
$Font_Travel = $Black
If $Picker_Font_Travel_Read = 1 Then
	$Font_Travel = $White
EndIf

$Picker_Font_Sick_Read = RegRead($DB, "Font_Sick")
$Font_Sick = $Black
If $Picker_Font_Sick_Read = 1 Then
	$Font_Sick = $White
EndIf

$Picker_Font_Blank_Read = 0x000000
$Font_Blank = $Black

$Picker_Font_Weekend_Read = RegRead($DB, "Font_Weekend")
$Font_Weekend = $Black

...
Global $BkpMenu_settings_colors = GUICtrlCreateMenu("Colors", $DBpMenu_settings)
Global $BkpMenu_settings_colors_On_Site = GUICtrlCreateMenuItem("On Site", $BkpMenu_settings_colors)
GUICtrlSetBkColor($BkpMenu_settings_colors_On_Site,$Color_bk_OnSite)
...
While 1
	...
	Switch $nMsg
		...
		Case $BkpMenu_settings_colors_On_Site
			_ColorPallet()

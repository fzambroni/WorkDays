#cs
Func oldGenerateWorkdaysReportHTML($Year, $Full)
...
;~ 	Local $Colors[9] = [$Color_bk_OnSite, $Color_bk_Remote, $Color_bk_holiday, $Color_bk_PTO, $Color_bk_Travel, $Color_bk_Sick, "#dddddd", $Color_bk_Blank, $Color_bk_Weekend]

;~ 	MsgBox(262144,"",$Color_bk_OnSite)
...
;~ 	For $m = 1 To 12
	For $m = 12 To 1 Step -1
		...
		While 1
					...
					For $Count_Note = 1 To $Note_Splited[0]
						If $Count_Note = 1 Then
							If $Note_Splited[$Count_Note] <> "" Then
								$CategoryNotes[$q][$CatIndex] = "<li><b>" & $DateStr & ":</b> " & $Note_Splited[$Count_Note] & "</li>" & $CategoryNotes[$q][$CatIndex]
							EndIf
						Else
							If $Note_Splited[$Count_Note] <> "" Then
								$CategoryNotes[$q][$CatIndex] = "<b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b> " & $Note_Splited[$Count_Note] & "<br>" & $CategoryNotes[$q][$CatIndex]
							EndIf
						EndIf
					Next
				Else
					$CategoryNotes[$q][$CatIndex] = "<li><b>" & $DateStr & ":</b> " & $Note & "</li>" & $CategoryNotes[$q][$CatIndex]
				EndIf
			Else
				...
				If $CatIndex <> 7 And $CatIndex <> 8 Then
					$CategoryNotes[$q][$CatIndex] = "<li>" & $DateStr & "</li>" & $CategoryNotes[$q][$CatIndex]
				EndIf
			EndIf
			...
			$i += 1
		WEnd
;~ 		MsgBox(262144,"",_ArrayDisplay($CategoryNotes))
	Next
...
;~ #ce
Func okGenerateWorkdaysReportHTML($Year, $Full)
...
;~ 	MsgBox(0, "WKHtmlToX", "Will now convert google.com to PDF.")
	...
	FileDelete(@ScriptDir & "\" & $OutputPath_temp)

	ShellExecute(@ScriptDir & "\" & $OutputPath)

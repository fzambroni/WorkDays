...
;~ #include "Workdays_Report_HTML.au3"
...
;~ 	_GUICtrlListView_SetView ($g_hLV, 3)
	...
	If $hHeader <> 0 Then
		If $g_hFontHeaderBold <> 0 Then _WinAPI_DeleteObject($g_hFontHeaderBold)
		$g_hFontHeaderBold = _WinAPI_CreateFont(18, 0, 0, 0, 700, False, False, False, _
...
;~ 	Local $iItem = _GUICtrlListView_AddItem($g_hLV, "")
	...
	$g_hFontNormal = _WinAPI_CreateFont(18, 0, 0, 0, 400, False, False, False, _
			$DEFAULT_CHARSET, $OUT_DEFAULT_PRECIS, $CLIP_DEFAULT_PRECIS, $DEFAULT_QUALITY, 0, "Segoe UI")

	$g_hFontBold = _WinAPI_CreateFont(18, 0, 0, 0, 700, False, False, False, _
			$DEFAULT_CHARSET, $OUT_DEFAULT_PRECIS, $CLIP_DEFAULT_PRECIS, $DEFAULT_QUALITY, 0, "Segoe UI")

	$g_hFontUnderline = _WinAPI_CreateFont(18, 0, 0, 0, 400, False, True, False, _
			$DEFAULT_CHARSET, $OUT_DEFAULT_PRECIS, $CLIP_DEFAULT_PRECIS, $DEFAULT_QUALITY, 0, "Segoe UI")

	$g_hFontBoldUnderline = _WinAPI_CreateFont(18, 0, 0, 0, 700, False, True, False, _
			$DEFAULT_CHARSET, $OUT_DEFAULT_PRECIS, $CLIP_DEFAULT_PRECIS, $DEFAULT_QUALITY, 0, "Segoe UI")
...
;~ 	$Slider_Border_Size = GUICtrlCreateSlider(70, 370, 150, 29, BitOR($GUI_SS_DEFAULT_SLIDER,$TBS_BOTH,$TBS_FIXEDLENGTH))
	$Slider_Border_Size = GUICtrlCreateSlider(65, 370, 150, 20, BitOR($GUI_SS_DEFAULT_SLIDER,$TBS_FIXEDLENGTH))
	GUICtrlSetLimit($Slider_Border_Size, 5, 0)
	GUICtrlSetData($Slider_Border_Size,$g_iQuarterBorderSize)
	$Label_Border_Size = GUICtrlCreateLabel(GUICtrlRead($Slider_Border_Size),140,390)

...
$Form_WorkDays = GUICreate("Work Days  -  " & @YEAR, $Window_X, $Window_Y, $WinPos_X, $WinPos_Y)
...
$Group_Buttons = GUICtrlCreateGroup(" Day Controls ", 288, 2, 272, 210)

; ── Row 1: Selected date + Quarter indicator + Reload ──────────────
$Label1 = GUICtrlCreateLabel("Date:", 296, 20, 32, 17)
$Input_SelDate = GUICtrlCreateInput("", 330, 17, 96, 22, $ES_READONLY)
GUICtrlSetData($Input_SelDate, GUICtrlRead($Calendar))
GUICtrlSetColor($Input_SelDate, 0x990000)
GUICtrlSetFont($Input_SelDate, 9, 700)
GUICtrlSetState($Input_SelDate, $gui_disable)
GUICtrlSetTip($Input_SelDate, "Currently selected date")

GUICtrlCreateLabel("Q:", 430, 20, 14, 17)
$Input_Quarter = GUICtrlCreateInput("", 444, 17, 22, 22, $ES_READONLY)
GUICtrlSetColor($Input_Quarter, 0x007B3B)
GUICtrlSetFont($Input_Quarter, 9, 700)
GUICtrlSetState($Input_Quarter, $gui_disable)
GUICtrlSetTip($Input_Quarter, "Current quarter")

$Button_Reload = GUICtrlCreateButton("Reload", 470, 17, 82, 22)
GUICtrlSetTip($Button_Reload, "Reload all data from the database")

; ── Update notification (hidden by default) ────────────────────────
$Button_Update = GUICtrlCreateButton("UPDATE AVAILABLE - Click to install", 296, 17, 252, 22, $SS_CENTER)
GUICtrlSetColor($Button_Update, 0xFF0000)
GUICtrlSetFont($Button_Update, 7, 700)
GUICtrlSetState($Button_Update, $GUI_HIDE)

; ── Row 2: Notes field (always visible) ───────────────────────────
GUICtrlCreateLabel("Notes:", 296, 46, 38, 17)
$Input_Tag = GUICtrlCreateInput("", 336, 43, 214, 21)
GUICtrlSetTip($Input_Tag, "Optional note for the selected day." & @CRLF & "Saved together with the day status.")

; ── Section label ──────────────────────────────────────────────────
GUICtrlCreateLabel("Mark selected day as:", 296, 72, 130, 16)

; ── Color legends (Today / Selected) ──────────────────────────────
$SelectLabel_1 = GUICtrlCreateLabel("", 440, 68, 48, 20)
$SelectLabel_2 = GUICtrlCreateLabel("", 442, 70, 44, 16)
GUICtrlSetBkColor($SelectLabel_1, $Color_bk_Today)
GUICtrlCreateLabel("Today", 442, 71, 44, 14, $SS_CENTER)
GUICtrlSetTip($SelectLabel_1, "Highlight color for today in the grid")

$TodayLabel_1 = GUICtrlCreateLabel("", 492, 68, 64, 20)
$TodayLabel_2 = GUICtrlCreateLabel("", 494, 70, 60, 16)
GUICtrlSetBkColor($TodayLabel_1, $Color_bk_Selected)
GUICtrlCreateLabel("Selected", 494, 71, 60, 14, $SS_CENTER)
GUICtrlSetTip($TodayLabel_1, "Highlight color for the selected date")

; ── Action buttons: 2 columns x 3 rows (88 x 34 px) ───────────────
$Button_OnSite = GUICtrlCreateButton("&On Site", 296, 90, 88, 34)
GUICtrlSetBkColor($Button_OnSite, $Color_bk_OnSite)
GUICtrlSetColor($Button_OnSite, $Font_OnSite)
GUICtrlSetFont($Button_OnSite, 9, 700)
GUICtrlSetTip($Button_OnSite, "Mark as On-Site workday" & @CRLF & "Shortcut: Alt+O")

$Button_Remote = GUICtrlCreateButton("&Remote", 388, 90, 88, 34)
GUICtrlSetBkColor($Button_Remote, $Color_bk_Remote)
GUICtrlSetColor($Button_Remote, $Font_Remote)
GUICtrlSetFont($Button_Remote, 9, 700)
GUICtrlSetTip($Button_Remote, "Mark as Remote workday" & @CRLF & "Shortcut: Alt+R")

$Button_holiday = GUICtrlCreateButton("&Holiday", 296, 128, 88, 34)
GUICtrlSetBkColor($Button_holiday, $Color_bk_holiday)
GUICtrlSetColor($Button_holiday, $Font_Holiday)
GUICtrlSetFont($Button_holiday, 9, 700)
GUICtrlSetTip($Button_holiday, "Mark as Holiday" & @CRLF & "Shortcut: Alt+H")

$Button_PTO = GUICtrlCreateButton("&PTO", 388, 128, 88, 34)
GUICtrlSetBkColor($Button_PTO, $Color_bk_PTO)
GUICtrlSetColor($Button_PTO, $Font_PTO)
GUICtrlSetFont($Button_PTO, 9, 700)
GUICtrlSetTip($Button_PTO, "Mark as Paid Time Off" & @CRLF & "Shortcut: Alt+P")

$Button_Travel = GUICtrlCreateButton("&Travel", 296, 166, 88, 34)
GUICtrlSetBkColor($Button_Travel, $Color_bk_Travel)
GUICtrlSetColor($Button_Travel, $Font_Travel)
GUICtrlSetFont($Button_Travel, 9, 700)
GUICtrlSetTip($Button_Travel, "Mark as Travel day" & @CRLF & "Shortcut: Alt+T")

$Button_Sick = GUICtrlCreateButton("&Sick", 388, 166, 88, 34)
GUICtrlSetBkColor($Button_Sick, $Color_bk_Sick)
GUICtrlSetColor($Button_Sick, $Font_Sick)
GUICtrlSetFont($Button_Sick, 9, 700)
GUICtrlSetTip($Button_Sick, "Mark as Sick day" & @CRLF & "Shortcut: Alt+S")

; ── Blank/Clear button spans the right column across both rows ─────
$Button_Blank = GUICtrlCreateButton("&Blank" & @CRLF & "/ Clear", 480, 90, 76, 110)
GUICtrlSetBkColor($Button_Blank, $Color_bk_Blank)
GUICtrlSetColor($Button_Blank, $Font_Blank)
GUICtrlSetFont($Button_Blank, 9, 400)
GUICtrlSetTip($Button_Blank, "Clear / remove day status" & @CRLF & "Also use for weekends" & @CRLF & "Shortcut: Alt+B")

; Weekend button hidden (kept for compatibility)
$Button_Weekend = GUICtrlCreateButton("&Weekend", 480, 166, 76, 34)
...
GUICtrlSetTip($Label_1_q1, "Total calendar days in the quarter")
$Label_2_q1 = GUICtrlCreateLabel("Work Days:", 576, 70, 75, 21, $SS_RIGHT)
GUICtrlSetTip($Label_2_q1, "Working days in the quarter (excluding weekends)")
$Label_3_q1 = GUICtrlCreateLabel("Ratio:", 576, 90, 75, 21, $SS_RIGHT)
GUICtrlSetTip($Label_3_q1, "Required On-Site percentage for the quarter")
$Label_ratio_q1 = GUICtrlCreateLabel("Ratio to Date:", 576, 110, 75, 21, $SS_RIGHT)
GUICtrlSetTip($Label_ratio_q1, "Required On-Site percentage up to today")

$Label_4_q1 = GUICtrlCreateLabel("Estim.On-Site: ", 705, 50, 65, 21, $SS_RIGHT)
GUICtrlSetTip($Label_4_q1, "Estimated On-Site days needed to meet the ratio")
$Label_5_q1 = GUICtrlCreateLabel("Real On-Site: ", 705, 70, 65, 21, $SS_RIGHT)
GUICtrlSetTip($Label_5_q1, "Actual On-Site days already logged this quarter")
$Label_6_q1 = GUICtrlCreateLabel("Remaining:", 705, 90, 65, 21, $SS_RIGHT)
GUICtrlSetTip($Label_6_q1, "On-Site days still needed to reach the target")
...
$Group_YSumary = GUICtrlCreateGroup(" Year Summary - " & @YEAR & " ", 865, 2, 270, 208)

$Label_YSumary_width = 65

$Label_YSumary = GUICtrlCreateLabel("Annual totals:", 870, 20, 90, 15)
GUICtrlSetFont($Label_YSumary, 9, 700)
...
GUICtrlSetTip($Label_YSumary_OnSite, "Total On-Site days this year")
...
$sMessage1 = "Work Days  v" & FileGetVersion(@ScriptFullPath) & "   |   Developed by Fabricio Zambroni   |   Today: " & @YEAR & "/" & @MON & "/" & @MDAY & "   |   Right-click on the grid to mark a day"
...
GUICtrlSetData($Label_LoadingMsg, "Initializing database...")
...
GUICtrlSetData($Label_LoadingMsg, "Checking data integrity...")
If GUICtrlRead($Button_Close_Splash) = $GUI_CHECKED Then
	Exit
EndIf
_DBRepair()
...
GUICtrlSetData($Label_LoadingMsg, "Loading year records...")
If GUICtrlRead($Button_Close_Splash) = $GUI_CHECKED Then
	Exit
EndIf
_ReadINI(@YEAR, 1)
...
GUICtrlSetData($Label_LoadingMsg, "Calculating statistics and KPIs...")
If GUICtrlRead($Button_Close_Splash) = $GUI_CHECKED Then
	Exit
EndIf
_CheckQuarter()
...
GUICtrlSetData($Label_LoadingMsg, "Creating automatic backup...")
If GUICtrlRead($Button_Close_Splash) = $GUI_CHECKED Then
	Exit
EndIf
;~ Sleep(100)
...
GUICtrlSetData($Label_LoadingMsg, "Building menus...")
If GUICtrlRead($Button_Close_Splash) = $GUI_CHECKED Then
	Exit
EndIf
_CreateMenu()
...
GUICtrlSetData($Label_LoadingMsg, "Ready!")
If GUICtrlRead($Button_Close_Splash) = $GUI_CHECKED Then
	Exit
EndIf
...
;~ 	$Form_About = GUICreate("About", 655, 617, $aPos[0], $aPos[1], $WS_SYSMENU,-1,$Form_WorkDays)
	$Form_About = GUICreate("About Work Days", 655, 617, 280, -40, $WS_SYSMENU, $WS_EX_MDICHILD, $Form_WorkDays)
	$Pic_About = GUICtrlCreatePic($AboutFile, 5, 5, 640, 360)
	$About_Text = "Work Days is a calendar-based application for tracking and categorizing your workdays (On-Site, Remote, Holiday, PTO, Travel, Sick, and more) throughout the year." & @CRLF & @CRLF & "Developed by Fabricio Zambroni  |  Current version: " & FileGetVersion(@ScriptFullPath)
	$Text_About = GUICtrlCreateEdit($About_Text, 5, 293, 640, 90, BitOR($ES_MULTILINE, $ES_READONLY), -1)
	GUICtrlSetFont($Text_About, 11)
	GUICtrlSetColor($Text_About, 0x1133CC)
...
Func _BKColorPallet()
	...
	GUICtrlCreateLabel("Font size:", 10, 405)
...
;~ 	#cs
	Global $Form_Tag = GUICreate("Add / Edit Note", 260, 185, $Mouse_Tag_Pos_X_New, $Mouse_Tag_Pos_Y_New, BitOR($WS_BORDER, $WS_POPUP, $DS_SETFOREGROUND, $DS_MODALFRAME), BitOR($WS_EX_TOPMOST, $WS_EX_TOOLWINDOW), $Form_WorkDays)

	$Label_Tag = GUICtrlCreateLabel("Date:  " & $CYear & "/" & $Month & "/" & $Day, 8, 10, 244, 18)
	GUICtrlSetFont($Label_Tag, 9, 700)
	$Button_Tag_Cancel = GUICtrlCreateButton("Cancel", 8, 152, 80, 25)
	$Edit_Tag = GUICtrlCreateEdit("", 8, 34, 244, 110, BitOR($ES_WANTRETURN, $WS_VSCROLL, $WS_HSCROLL, $ES_AUTOVSCROLL, $ES_AUTOHSCROLL, $ES_NOHIDESEL))
	$Button_Tag_Save = GUICtrlCreateButton("Save", 172, 152, 80, 25, $BS_DEFPUSHBUTTON)
;~ 	#ce
	#cs
...
;~ 			GUICtrlSetData($Input_Quarter, "Q4")
	...
	; ── Live status bar: show selected date + current status ────────
	Local $sSel = GUICtrlRead($Input_SelDate)
	If $sSel <> "" Then
		Local $aSelSplit = StringSplit($sSel, "/")
		If Not @error And $aSelSplit[0] = 3 Then
			Local $sRegSB = RegRead($DB & "\" & $aSelSplit[1] & "\" & $aSelSplit[2], $aSelSplit[3])
			Local $sCodeSB = StringLeft($sRegSB, 1)
			Local $sLabelSB = "Blank"
			Switch $sCodeSB
				Case "W" : $sLabelSB = "Weekend"
				Case "O" : $sLabelSB = "On-Site"
				Case "R" : $sLabelSB = "Remote"
				Case "T" : $sLabelSB = "Travel"
				Case "P" : $sLabelSB = "PTO"
				Case "H" : $sLabelSB = "Holiday"
				Case "S" : $sLabelSB = "Sick"
				Case Else : $sLabelSB = "Blank"
			EndSwitch
			_GUICtrlStatusBar_SetText($StatusBar1, "  Selected: " & $sSel & "   |   Status: " & $sLabelSB & "   |   Today: " & @YEAR & "/" & @MON & "/" & @MDAY & "   |   Work Days  v" & FileGetVersion(@ScriptFullPath), 0)
		EndIf
	EndIf
...
Func _MenuContextual($U, $V, $SelYear)
	...
	If Not _AppendPopupMenu($hMenu, $MF_STRING, $IDM_TAG, "Add / Edit Note...") Then Return _DestroyPopupFail($hMenu, 4)
	If Not _AppendPopupMenu($hMenu, $MF_SEPARATOR, 0, "") Then Return _DestroyPopupFail($hMenu, 5)
	If Not _AppendPopupMenu($hMenu, $MF_STRING, $IDM_ONSITE, "On-Site  (in-office)") Then Return _DestroyPopupFail($hMenu, 6)
	If Not _AppendPopupMenu($hMenu, $MF_STRING, $IDM_REMOTE, "Remote  (work from home)") Then Return _DestroyPopupFail($hMenu, 7)
	If Not _AppendPopupMenu($hMenu, $MF_STRING, $IDM_HOLIDAY, "Holiday") Then Return _DestroyPopupFail($hMenu, 8)
	If Not _AppendPopupMenu($hMenu, $MF_STRING, $IDM_PTO, "PTO  (paid time off)") Then Return _DestroyPopupFail($hMenu, 9)
	If Not _AppendPopupMenu($hMenu, $MF_STRING, $IDM_TRAVEL, "Travel") Then Return _DestroyPopupFail($hMenu, 10)
	If Not _AppendPopupMenu($hMenu, $MF_STRING, $IDM_SICK, "Sick  (sick day / leave)") Then Return _DestroyPopupFail($hMenu, 11)
	If Not _AppendPopupMenu($hMenu, $MF_STRING, $IDM_BLANK, "Blank / Clear  (weekends)") Then Return _DestroyPopupFail($hMenu, 12)
...
Func _splash($Mode = "on")
	...
	If $Mode = "on" Then
		...
		Global $Label_LoadingMsg = GUICtrlCreateLabel("Loading...", 108, 308, 300, -1, $SS_SIMPLE)
		GUICtrlSetColor($Label_LoadingMsg, 0xFFFFFF)
		GUICtrlSetBkColor($Label_LoadingMsg, 0x5b90b2)
		Global $Label_version = GUICtrlCreateLabel("v" & FileGetVersion(@ScriptFullPath), 560, 330, -1, -1, $SS_SIMPLE)
